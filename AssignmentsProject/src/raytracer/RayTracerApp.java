...
public class RayTracerApp extends JFrame implements Runnable {	
	...
	public static void main(String[] args) {	
		...
		RayTracerApp app = new RayTracerApp();
		if (args.length == 0) {
			app.openSceneList();
		} else {
	...
	public void openSceneList(){
		File folder = new File("renderData");
		...
		if ( listOfFiles == null || listOfFiles.length == 0 ) {
			System.err.println("No xml files in renderData directory?");
			System.exit(-1);
		}
