...
public class A1App implements GLEventListener {
    ...
    public void init(GLAutoDrawable drawable) {
        ...
        gl.glClearColor(0.33f, 0.33f, 0.33f, 1f);
        ...
        // Here we set up a default material, cyan on the front, magenta on the back,
        // with white highlights (i.e., like shiny plastic)
